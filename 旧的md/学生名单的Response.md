...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/sms/assets/45e0cf9f/bootstrap-datepicker/css/datepicker.min.css" />
...
<script type="text/javascript" src="/sms/assets/45e0cf9f/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
...
<script type="text/javascript" src="/sms/assets/45e0cf9f/bootstrap-datepicker/js/locales/bootstrap-datepicker.zh.js"></script>
...
<title>CHUNG HUA HIGH SCHOOL - 输入校外实习和特殊绩效分数</title>
  ...
  (function () {
    ...
    var currentTime = new Date("May 26 2026 03:25:52 PM");
...
<div class="bootstrap-widget"><div class="bootstrap-widget-header"><i class="icon-plus-sign"></i><h3>创建 输入校外实习和特殊绩效分数</h3><div class="bootstrap-toolbar pull-right"><div class=" pull-right btn-group"><a class="btn" id="yw1" href="index.php?r=transaction/studentPerformance/">重返</a></div></div></div><div class="bootstrap-widget-content" id="yw0"><div class="row-fluid">
	<div class="span12">
		<form class="form-horizontal" id="student-performance-m-form" action="/sms/index.php?StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;r=transaction%2FstudentPerformance%2Fcreate" method="post">
...
<thead>
<tr>
<th class="span2" style="text-align:center" id="student-performance-m-grid_c0"><a class="sort-link" href="/sms/index.php?r=transaction/studentPerformance/create&amp;StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;id_sort=student_no">学号 </a></th><th class="span3" style="text-align:center" id="student-performance-m-grid_c1"><a class="sort-link" href="/sms/index.php?r=transaction/studentPerformance/create&amp;StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;id_sort=student_name">姓名(英) </a></th><th class="span2" style="text-align:center" id="student-performance-m-grid_c2"><a class="sort-link" href="/sms/index.php?r=transaction/studentPerformance/create&amp;StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;id_sort=student_cname">姓名(中) </a></th><th class="span2" style="text-align:center" id="student-performance-m-grid_c3"><a class="sort-link" href="/sms/index.php?r=transaction/studentPerformance/create&amp;StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;id_sort=class_english_name">班级 </a></th><th class="span2" style="text-align:center" id="student-performance-m-grid_c4"><a class="sort-link" href="/sms/index.php?r=transaction/studentPerformance/create&amp;StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;id_sort=type_of_bonus">奖励分数类型 </a></th><th class="span1" style="text-align:center" id="student-performance-m-grid_c5"><a class="sort-link" href="/sms/index.php?r=transaction/studentPerformance/create&amp;StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;id_sort=mark">备注 </a></th><th class="span2" style="text-align:center" id="student-performance-m-grid_c6"><a class="sort-link" href="/sms/index.php?r=transaction/studentPerformance/create&amp;StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;id_sort=mark">奖励分数 </a></th><th class="span1" style="text-align:center" id="student-performance-m-grid_c7">&nbsp;</th></tr>
</thead>
<tbody>
<tr><td colspan="8" class="empty"><span class="empty">没有找到数据.</span></td></tr>
</tbody>
</table>
<div class="keys" style="display:none" title="/sms/index.php?StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;r=transaction%2FstudentPerformance%2Fcreate"></div>
</div>  </div>
</div>
...
<div class="summary">第 1-47 条, 共 47 条.</div>
<table class="table table-striped table-bordered table-condensed table">
<thead>
<tr>
...
<tr class="odd">
<td class="span2" style="text-align:center">23090</td><td class="span4">BERNICE WONG </td><td class="span2" style="text-align:center">黄芷恩</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="6885" data-student_name="BERNICE WONG " data-student_cname="黄芷恩" data-class_name="S1B" data-student_no="23090" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23464</td><td class="span4">TENG YEE SING</td><td class="span2" style="text-align:center">陈宇芯</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="6901" data-student_name="TENG YEE SING" data-student_cname="陈宇芯" data-class_name="S1B" data-student_no="23464" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23163</td><td class="span4">LEE LIN YUN</td><td class="span2" style="text-align:center">李霖岳</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="6902" data-student_name="LEE LIN YUN" data-student_cname="李霖岳" data-class_name="S1B" data-student_no="23163" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23081</td><td class="span4">GOH XUE TAO</td><td class="span2" style="text-align:center">吴学涛</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="6960" data-student_name="GOH XUE TAO" data-student_cname="吴学涛" data-class_name="S1B" data-student_no="23081" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23413</td><td class="span4">NG JUN HONG</td><td class="span2" style="text-align:center">吴俊宏</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="6971" data-student_name="NG JUN HONG" data-student_cname="吴俊宏" data-class_name="S1B" data-student_no="23413" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23070</td><td class="span4">LAM YOU JUN</td><td class="span2" style="text-align:center">林有俊</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="6980" data-student_name="LAM YOU JUN" data-student_cname="林有俊" data-class_name="S1B" data-student_no="23070" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23051</td><td class="span4">CHOONG EE SERN</td><td class="span2" style="text-align:center">锺奕森</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="6983" data-student_name="CHOONG EE SERN" data-student_cname="锺奕森" data-class_name="S1B" data-student_no="23051" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23052</td><td class="span4">ANDREW CHAN JING TIAN</td><td class="span2" style="text-align:center">陈靖添</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="6985" data-student_name="ANDREW CHAN JING TIAN" data-student_cname="陈靖添" data-class_name="S1B" data-student_no="23052" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23151</td><td class="span4">TAN GIN EU</td><td class="span2" style="text-align:center">陈竞尧</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7003" data-student_name="TAN GIN EU" data-student_cname="陈竞尧" data-class_name="S1B" data-student_no="23151" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23201</td><td class="span4">LIM JUN FENG</td><td class="span2" style="text-align:center">林骏锋</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7007" data-student_name="LIM JUN FENG" data-student_cname="林骏锋" data-class_name="S1B" data-student_no="23201" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23125</td><td class="span4">YONG HOK HONG</td><td class="span2" style="text-align:center">杨学航</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7025" data-student_name="YONG HOK HONG" data-student_cname="杨学航" data-class_name="S1B" data-student_no="23125" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23071</td><td class="span4">KLAUDELLE JOY LIM XIN YI</td><td class="span2" style="text-align:center">林芯怡</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7030" data-student_name="KLAUDELLE JOY LIM XIN YI" data-student_cname="林芯怡" data-class_name="S1B" data-student_no="23071" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23414</td><td class="span4">CHUA WEI FENG</td><td class="span2" style="text-align:center">蔡伟丰</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7040" data-student_name="CHUA WEI FENG" data-student_cname="蔡伟丰" data-class_name="S1B" data-student_no="23414" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23379</td><td class="span4">ONG YI TENG</td><td class="span2" style="text-align:center">王依婷</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7044" data-student_name="ONG YI TENG" data-student_cname="王依婷" data-class_name="S1B" data-student_no="23379" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23178</td><td class="span4">GAN JUN JIET</td><td class="span2" style="text-align:center">颜浚捷</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7059" data-student_name="GAN JUN JIET" data-student_cname="颜浚捷" data-class_name="S1B" data-student_no="23178" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23171</td><td class="span4">DARIUS GOH YEE XUAN</td><td class="span2" style="text-align:center">胡宇轩</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7083" data-student_name="DARIUS GOH YEE XUAN" data-student_cname="胡宇轩" data-class_name="S1B" data-student_no="23171" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23395</td><td class="span4">BENEDICT SIM JING TENG  </td><td class="span2" style="text-align:center">沈靖駦</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7086" data-student_name="BENEDICT SIM JING TENG  " data-student_cname="沈靖駦" data-class_name="S1B" data-student_no="23395" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23082</td><td class="span4">CHUA TIAN JIAN</td><td class="span2" style="text-align:center">蔡天坚</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7120" data-student_name="CHUA TIAN JIAN" data-student_cname="蔡天坚" data-class_name="S1B" data-student_no="23082" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23315</td><td class="span4">WONG KAI JER</td><td class="span2" style="text-align:center">黄凯泽</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7126" data-student_name="WONG KAI JER" data-student_cname="黄凯泽" data-class_name="S1B" data-student_no="23315" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23103</td><td class="span4">YAP JUN ONN</td><td class="span2" style="text-align:center">叶浚安</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7140" data-student_name="YAP JUN ONN" data-student_cname="叶浚安" data-class_name="S1B" data-student_no="23103" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23248</td><td class="span4">LOH KAH YUEN</td><td class="span2" style="text-align:center">罗嘉渊</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7149" data-student_name="LOH KAH YUEN" data-student_cname="罗嘉渊" data-class_name="S1B" data-student_no="23248" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23455</td><td class="span4">CHOK QIAN RU</td><td class="span2" style="text-align:center">卓谦柔</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7199" data-student_name="CHOK QIAN RU" data-student_cname="卓谦柔" data-class_name="S1B" data-student_no="23455" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23121</td><td class="span4">LIN CHEAN YE</td><td class="span2" style="text-align:center">林芊悦</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7244" data-student_name="LIN CHEAN YE" data-student_cname="林芊悦" data-class_name="S1B" data-student_no="23121" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23448</td><td class="span4">ANG WEI XING</td><td class="span2" style="text-align:center">洪玮杏</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7334" data-student_name="ANG WEI XING" data-student_cname="洪玮杏" data-class_name="S1B" data-student_no="23448" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23196</td><td class="span4">WONG SENG HEI</td><td class="span2" style="text-align:center">黄承熙</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7337" data-student_name="WONG SENG HEI" data-student_cname="黄承熙" data-class_name="S1B" data-student_no="23196" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">23525</td><td class="span4">RANDY WOO TZE YANG</td><td class="span2" style="text-align:center">胡智洋</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7386" data-student_name="RANDY WOO TZE YANG" data-student_cname="胡智洋" data-class_name="S1B" data-student_no="23525" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">23563</td><td class="span4">CHAN YING EN</td><td class="span2" style="text-align:center">陈荧恩</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="7418" data-student_name="CHAN YING EN" data-student_cname="陈荧恩" data-class_name="S1B" data-student_no="23563" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="even">
<td class="span2" style="text-align:center">24497</td><td class="span4">LOH KE RU</td><td class="span2" style="text-align:center">罗可洳</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="8083" data-student_name="LOH KE RU" data-student_cname="罗可洳" data-class_name="S1B" data-student_no="24497" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
<tr class="odd">
<td class="span2" style="text-align:center">25595</td><td class="span4">VESPERA ANG CHENG WUEY</td><td class="span2" style="text-align:center">洪千惠</td><td class="span2" style="text-align:center">S1B</td><td><div class="btn-group" /><a onclick="addToEkstra(this);return false;" data-student_id="8898" data-student_name="VESPERA ANG CHENG WUEY" data-student_cname="洪千惠" data-class_name="S1B" data-student_no="25595" data-class_id="734" data-mark_item="0.00" class="btn" href="#"><icon class="icon-ok"></icon></a></div></td></tr>
</tbody>
</table>
<div class="keys" style="display:none" title="/sms/index.php?StudentPerformanceM%5Bclass_id%5D=734&amp;StudentPerformanceM%5Bitem_id%5D=2444&amp;ajax=student-grid&amp;r=transaction%2FstudentPerformance%2Fcreate"><span>6674</span><span>6677</span><span>6704</span><span>6707</span><span>6715</span><span>6725</span><span>6729</span><span>6730</span><span>6741</span><span>6743</span><span>6749</span><span>6751</span><span>6758</span><span>6767</span><span>6773</span><span>6783</span><span>6810</span><span>6811</span><span>6885</span><span>6901</span><span>6902</span><span>6960</span><span>6971</span><span>6980</span><span>6983</span><span>6985</span><span>7003</span><span>7007</span><span>7025</span><span>7030</span><span>7040</span><span>7044</span><span>7059</span><span>7083</span><span>7086</span><span>7120</span><span>7126</span><span>7140</span><span>7149</span><span>7199</span><span>7244</span><span>7334</span><span>7337</span><span>7386</span><span>7418</span><span>8083</span><span>8898</span></div>
</div>    </div>
